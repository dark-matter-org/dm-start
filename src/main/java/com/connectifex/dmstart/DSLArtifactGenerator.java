...
/**
 * The DSLArtifactGenerator will generate a variety of artifacts that form the basis for 
 * a new dark-matter based domain specific language.
 */
public class DSLArtifactGenerator {
	...
	private String		testDir;				// workspace/dslProject/test/dslPackagePath/tools/DSLutil
	
	private String		dataDir;				// workspace/dslProject/test/dslPackagePath/tools/DSLutil/data
	private String		exampleFile;			// workspace/dslProject/test/dslPackagePath/tools/DSLutil/data/example.DSLABBREV
	 ...
	 * @param src the source folder name
	 * @param dpack the base package
	 * @param folder the full package folder name
	 * @param abbrev the DSL abbreviation
	 * @param name the DSL module name prefix
	...
	/**
	 * Generates the initial utility that can be called to load DSL specifications
	 * and perform something associated with hte DSL.
	 * @throws IOException
	 */
	...
	/**
	 * Generates a unit test that calls the DSL utility.
	 * @throws IOException
	 */
	...
	/**
	 * Generates an example DSL module file that will be loaded by the unit test.
	 * @throws IOException
	 */
	...
	/**
	 * Executes the dark-matter object (DMO) generation process to create the DMOs from the DSL
	 * schema files.
	 * @throws ResultException
	 * @throws IOException
	 * @throws DmcValueException
...
//					"-debug"
	...
	/**
	 * Executes the dark-matter generation for the "server" side of the DSL - these are the classes
	 * that can be extended to add behaviour to the DSL.
	 * @throws ResultException
	 * @throws IOException
	 * @throws DmcValueException
	 * @throws DmcValueExceptionSet
	...
	/**
	 * Creates the base schema file for the DSL - this will refer to the other files that specify
	 * the type, complex types, attributes and classes.
	 * @throws IOException
	 */
	...
	/**
	 * Creates the module specification file.
	 * @throws IOException
	 */
	...
	/**
	 * Creates the example class specification file.
	 * @throws IOException
	 */
	...
	/**
	 * Creates the example complex types file.
	 * @throws IOException
	 */
	...
	/**
	 * Creates the example types file.
	 * @throws IOException
	 */
	...
	/**
	 * Creates the example attributes file.
	 * @throws IOException
	 */
	...
	/**
	 * Creates a .gitignore file that ignores generated code
	 * @param dir the place to craete the file
	 * @throws IOException
	 */
